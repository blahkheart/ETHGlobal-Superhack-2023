    ...
    <main className="bg-[#221e29]">
      ...
      <section>
        <div className="container mx-auto my-24 flex flex-wrap px-8 md:px-0">
          <div className="w-full md:w-3/5 md:text-left text-center mb-12 md:mb-2">
            <p className="md:text-2xl uppercase font-light mb-4 md:capitalize md:font-normal">The future of NFT</p>
            <h1 className="md:text-5xl text-3xl leading-[1.5] md:leading-[1.5] font-[600] gradient-text">
            ...
            <div className="flex items-center justify-center mt-6 md:block">
      ...
      >
        <div className="container flex flex-col mx-auto py-32 items-center justify-center text-center">
          ...
          <p className="text-3xl md:w-[55%] leading-[1.7] font-[500]">
